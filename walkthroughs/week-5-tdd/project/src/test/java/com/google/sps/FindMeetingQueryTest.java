...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void noMandatoryOnlyOptionalAttendees() {
    ...
    Collection<Event> events =
        Arrays.asList(
            ...
            new Event(
                "Event 2",
                TimeRange.fromStartDuration(TIME_0915AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 3",
  ...
  @Test
  public void everyAttendeeIsConsideredPart2() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredPart3() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomPart2() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  @Test
  public void notEnoughRoomWithOptionalAttendees() {
    // Have one person, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A-----| |-----B----|
